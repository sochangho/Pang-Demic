...
namespace GameVanilla.Game.UI
{
    ...
    public class ProgressBar : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (PlayerPrefs.GetInt("next_level") <= PuzzleMatchManager.instance.lastSelectedLevel)
            {

                progressAction = SetTotalstar;
            }
        ...
        {
            var total_star = PlayerPrefs.GetInt("totalstar");
            total_star++;
            PlayerPrefs.SetInt("totalstar", total_star);
        ...
        public void UpdateProgressBar(int score)
        {
            ...
            {
                star1Achieved = true;
                star1Image.Activate(progressAction);
            ...
            {
                star2Achieved = true;
                star2Image.Activate(progressAction);
                girl.GetComponent<Animator>().SetTrigger("Happy");
                SoundManager.instance.PlaySound("StarProgressBar");
            }
            ...
            {
                star3Achieved = true;
                star3Image.Activate(progressAction);
                girl.GetComponent<Animator>().SetTrigger("Happy");
                SoundManager.instance.PlaySound("StarProgressBar");
            }
