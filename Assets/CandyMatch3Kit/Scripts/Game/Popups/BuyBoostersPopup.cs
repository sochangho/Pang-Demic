	    ...
	    public void SetBooster(BuyBoosterButton button)
		{
			...
			switch (button.boosterType)
			{
				case BoosterType.Lollipop:
					...
					boosterNameText.text = "Ringer";  //"Lollipop";
					boosterDescriptionText.text = "Destroy one germ of your choice on the board.";
					break;

				case BoosterType.Bomb:
					boosterImage.sprite = bombSprite;
					boosterNameText.text = "Soap";//"Bomb";
					boosterDescriptionText.text = "Destroy all the adjacent germs.";
					break;

				case BoosterType.Switch:
					boosterImage.sprite = switchSprite;
					boosterNameText.text = "Syringe";// Switch";
					boosterDescriptionText.text = "Switch two germs.";
					break;

				case BoosterType.ColorBomb:
					boosterImage.sprite = colorBombSprite;
					boosterNameText.text = "First aid kit";//Color bomb";
					boosterDescriptionText.text = "Destroy all the germs of the same random color.";
					break;
			}
